...
void ept_l1_init()
{
  for (int index_l1 = 0; index_l1 < LPAE_L1_SIZE; index_l1++)  // 8项
  {
    lpae_t entry_l1;
    lpae_t *ept_l2 = &ept_L2_root[LPAE_ENTRIES * index_l1];  // 512 * 8 = 4096 项
    ...
    ept_l2_init(ept_l2, index_l1);    //  ept2_base + 0 * 512
  }
  apply_ept(ept_L1);
}
